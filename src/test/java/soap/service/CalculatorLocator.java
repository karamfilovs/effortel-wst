...
public class CalculatorLocator extends org.apache.axis.client.Service implements Calculator {
    ...
    public CalculatorSoap_PortType getCalculatorSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public CalculatorSoap_PortType getCalculatorSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            CalculatorSoap12Stub _stub = new CalculatorSoap12Stub(portAddress, this);
    ...
    public CalculatorSoap_PortType getCalculatorSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public CalculatorSoap_PortType getCalculatorSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            CalculatorSoap_BindingStub _stub = new CalculatorSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (CalculatorSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                CalculatorSoap12Stub _stub = new CalculatorSoap12Stub(new java.net.URL(CalculatorSoap12_address), this);
                _stub.setPortName(getCalculatorSoap12WSDDServiceName());
                return _stub;
            }
            if (CalculatorSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                CalculatorSoap_BindingStub _stub = new CalculatorSoap_BindingStub(new java.net.URL(CalculatorSoap_address), this);
                _stub.setPortName(getCalculatorSoapWSDDServiceName());
                return _stub;
            }
        }
